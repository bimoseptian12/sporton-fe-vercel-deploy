    ...
    <CardWithHeader title="Payment Steps">
      <div className="p-4">
        <ol className="list-decimal text-xs pl-2 flex flex-col gap-4">
          <li className="">
            ...
            preferred bank account listed under 'Payment Options' (BCA, Mandiri,
            or BTPN).
          </li>
          <li>
      ...
      <div className="border-t border-gray-200 py-4 px-4">
        <div className="flex justify-between">
          ...
          <div className="text-primary text-xs">{PriceConverter(1035000)}</div>
        </div>
        <Button
          variant="dark"
        ...
        >
          <FiCheckCircle></FiCheckCircle> Upload Receipt & Confirm
        </Button>
      </div>
    </CardWithHeader>
  );
